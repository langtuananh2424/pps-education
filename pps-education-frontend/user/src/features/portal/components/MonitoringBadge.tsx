  ...
  return (
    <div className="relative shrink-0">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        aria-label="Trạng thái giám sát chống gian lận"
        ...
        <>
          ...
          >
            <p className="text-[11px] font-bold text-amber-800 leading-relaxed">
              Đang giám sát quá trình làm bài — thoát ra ngoài ({exitNote ?? "đổi tab/thu nhỏ"}) sẽ được ghi nhận.
              {hasViolation && ` Đã ghi nhận ${violationCount} lần.`}
            </p>
          </div>
        </>
      )}
