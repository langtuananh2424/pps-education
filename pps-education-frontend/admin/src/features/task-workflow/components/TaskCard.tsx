  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <span className="text-xs font-bold text-slate-900 group-hover:text-brand-orange transition-colors">{task.title}</span>
      </div>
      ...
      <div className="border-t border-slate-100 pt-2.5 mt-3 flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[10px] font-semibold text-slate-600 truncate max-w-[80px]">{task.assignedTo}</span>
        </div>
