      ...
      {open && (
        <div className="absolute z-10 mt-1 w-full bg-white border border-slate-200 rounded-lg shadow-lg max-h-80 overflow-y-auto">
          {loading ? (
            ...
            <p className="px-3 py-2 text-sm text-slate-400 italic">Không tìm thấy tài khoản nào.</p>
          ) : (
          ...
          {!loading && truncated && (
            <p className="px-3 py-1.5 text-sm text-amber-600 bg-amber-50 border-t border-amber-100 italic">
