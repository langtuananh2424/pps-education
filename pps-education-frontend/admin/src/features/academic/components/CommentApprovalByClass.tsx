...
export default function CommentApprovalByClass({ items, loading, onDecided }: CommentApprovalByClassProps) {
  ...
  if (items.length === 0) return <p className="text-sm text-slate-400 italic text-center py-6">Chưa có nhận xét nào chờ duyệt.</p>;
            ...
            <div className="px-5 py-3 border-b border-slate-100 bg-slate-50 flex items-center justify-between flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold rounded-lg disabled:opacity-50"
                >
              ...
              return (
                <div key={date} className="border-b border-slate-100 last:border-b-0">
                  <div className="px-5 py-2 bg-slate-50/60 flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-sm text-slate-400">{dateItems.length} học sinh</span>
                    ...
                    {dateItems[0]?.lessonContent && (
                      <span className="text-sm text-amber-700 font-semibold">· Bài học hôm nay: {dateItems[0].lessonContent}</span>
                    )}
                  </div>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex justify-end gap-1.5">
                                  <button
                                    ...
                                    className="px-2 py-1 text-slate-500 hover:bg-slate-100 text-sm font-bold rounded-lg"
                                  >
                                    Hủy
                                  </button>
                                  <button
                                    ...
                                    className="px-2 py-1 bg-brand-red hover:bg-red-700 text-white text-sm font-bold rounded-lg disabled:opacity-50"
                                  >
                          ...
                          <Td className="min-w-[230px] whitespace-nowrap border-r border-slate-300">
                            <div className="flex gap-1.5 flex-nowrap">
                              <button
                                ...
                                className="px-2 py-1 text-slate-600 hover:bg-slate-100 border border-slate-200 text-sm font-bold rounded-lg disabled:opacity-50"
                              >
                              ...
                              <button
                                ...
                                disabled={decidingId === cm.id || editingId === cm.id}
                                className="px-2 py-1 text-rose-600 hover:bg-rose-50 border border-rose-200 text-sm font-bold rounded-lg disabled:opacity-50"
                              >
                              ...
                              <button
                                ...
                                disabled={decidingId === cm.id || editingId === cm.id}
                                className="px-2 py-1 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold rounded-lg disabled:opacity-50"
                              >
