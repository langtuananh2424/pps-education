...
public class NotificationEmailTemplateService {
    ...
    /** Giữ chỗ trong nội dung mẫu, thay bằng Hotline thực tế lúc render (xem {@link #resolveHotline}). */
    private static final String HOTLINE_TOKEN = "{hotline}";
    ...
    public Optional<EmailTemplate> renderFor(Notification.NotificationType type, String studentName, String className,
                                             String siteManagerHotline) {
        TemplateSpec spec = templates.get(type);
        if (spec == null) {
            return Optional.empty();
        }
        String effectiveHotline = resolveHotline(spec, siteManagerHotline);
        ...
        for (String paragraph : spec.bodyParagraphs()) {
            html.append("<p>").append(escape(paragraph.replace(HOTLINE_TOKEN, effectiveHotline))).append("</p>");
        }
        html.append(footerHtml(spec.audience(), spec.footerContactLine(), effectiveHotline));
    ...
    private void registerTemplates() {
        templates.put(Notification.NotificationType.STUDENT_ATTITUDE_ALERT, spec(
                ...
                "Nếu cần trao đổi thêm, vui lòng liên hệ Hotline: " + HOTLINE_TOKEN + "."));
        ...
        templates.put(Notification.NotificationType.STUDENT_ATTITUDE_ESCALATION_PENDING_APPROVAL, spec(
                ...
                "Nếu cần hỗ trợ, vui lòng liên hệ Hotline: " + HOTLINE_TOKEN + "."));
        ...
        templates.put(Notification.NotificationType.STUDENT_ATTITUDE_ESCALATION, spec(
                ...
                "Mọi thông tin vui lòng liên hệ Hotline: " + HOTLINE_TOKEN + "."));
        ...
        templates.put(Notification.NotificationType.HOMEWORK_MISS_REMINDER, spec(
                ...
                "Nếu cần hỗ trợ hoặc có bất kỳ thắc mắc nào, vui lòng liên hệ Hotline: " + HOTLINE_TOKEN + "."));
        ...
        templates.put(Notification.NotificationType.HOMEWORK_MISS_WARNING, spec(
                ...
                "Nếu cần được tư vấn hoặc hỗ trợ, vui lòng liên hệ Hotline: " + HOTLINE_TOKEN + "."));
        ...
        templates.put(Notification.NotificationType.HOMEWORK_MISS_PARENT_MEETING_INVITE, specWithFooterContact(
                ...
                "Phụ huynh vui lòng liên hệ Quản lý điểm trường: " + HOTLINE_TOKEN + ".",
        ...
        templates.put(Notification.NotificationType.HOMEWORK_DUE_SOON_REMINDER, spec(
                ...
                "Mọi hỗ trợ vui lòng liên hệ Hotline: " + HOTLINE_TOKEN + "."));
        ...
        templates.put(Notification.NotificationType.ATTENDANCE_ABSENT, spec(
                ...
                "Trong trường hợp học sinh nghỉ có phép, Quý Phụ huynh vui lòng thông báo với giáo viên phụ trách hoặc Quản lý điểm trường Hotline: " + HOTLINE_TOKEN + "."));
        ...
        templates.put(Notification.NotificationType.EXAM_INTEGRITY_VIOLATION_PARENT, spec(
                ...
                "Nếu cần hỗ trợ hoặc có thắc mắc liên quan đến kết quả ghi nhận của hệ thống, vui lòng liên hệ Hotline: " + HOTLINE_TOKEN + "."));
     ...
     */
    private String footerHtml(String audience, String footerContactLine, String effectiveHotline) {
        String contactLine = footerContactLine != null
                ? footerContactLine.replace(HOTLINE_TOKEN, effectiveHotline)
        ...
        return "<hr/>"
                ...
                + "<p>Hotline: " + escape(effectiveHotline) + "<br/>"
