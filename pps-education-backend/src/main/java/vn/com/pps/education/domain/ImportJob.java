 ...
 * nhận với người dùng), UC-72 (CURRICULUM_CATALOG — import Excel nhanh
 * mục lục Sách/Unit/Sub Topic/Lesson (exams)/Bài (exercises) của Kho đề,
 * bổ sung ngoài SDD gốc, đã xác nhận với người dùng 2026-09-13) dùng
 * chung bảng này —
...
public class ImportJob {
    ...
    public enum ImportType { SHIFTS, EMPLOYEE_SHIFTS, WORK_CALENDAR, STUDENTS, ATTENDANCE, TEACHING_SCHEDULE, PARENTS, EMPLOYEES, GRADES, DAILY_COMMENTS, QUESTIONS, CLASS_ENROLLMENTS, REVIEW_VIDEO_QUESTIONS, REVIEW_VIDEO_CONNECTION_QUESTIONS, CURRICULUM_CATALOG, REVIEW_VIDEO_CATALOG }
