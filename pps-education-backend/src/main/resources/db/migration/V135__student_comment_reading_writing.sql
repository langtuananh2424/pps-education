...
COMMENT ON COLUMN student_comments.homework_previous_reading_score IS 'BTVN buổi trước - Offline - Reading: điểm % giáo viên tự chấm tay (chỉ buổi teacher_type=VIETNAMESE, V135).';
COMMENT ON COLUMN student_comments.homework_previous_writing_score IS 'BTVN buổi trước - Offline - Writing: điểm % giáo viên tự chấm tay (chỉ buổi teacher_type=VIETNAMESE, V135).';
COMMENT ON COLUMN student_comments.homework_next_reading IS 'BTVN (giao buổi sau) - Offline - Reading: mô tả bài + trang giao offline (chỉ buổi teacher_type=VIETNAMESE, V135).';
COMMENT ON COLUMN student_comments.homework_next_writing IS 'BTVN (giao buổi sau) - Offline - Writing: mô tả bài + trang giao offline (chỉ buổi teacher_type=VIETNAMESE, V135).';
